...
<div class="container mx-auto p-4">
    <div class="my-16 text-center" id="title">
        <h1 class="mb-3 text-3xl font-extrabold text-neutral-950 dark:text-white md:text-4xl">Switch</h1>
        <p class="text-neutral-950 dark:text-white">A showcase of switch components built with Svelte and TailwindCSS.</p>
    </div>
    ...
    <div class={`grid grid-cols-1 sm:grid-cols-4 md:grid-cols-4 gap-0`}>
        ...
        >
            <div class="flex flex-col gap-4 mx-auto">
                <Switch disabled={card.disabled} checked={card.checked} color={card.color} />
            </div>
