...
<div class="container mx-auto p-4">
    <div class="my-16 text-center" id="title">
        <h1 class="mb-3 text-3xl font-extrabold text-neutral-950 dark:text-white md:text-4xl">Avatar</h1>
        <p class="text-neutral-950 dark:text-white">A showcase of avatar components built with Svelte and TailwindCSS.</p>
    </div>
