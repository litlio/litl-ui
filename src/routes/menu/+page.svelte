...
<div class="container mx-auto p-4">
    <div class="my-16 text-center" id="title">
        <h1 class="mb-3 text-3xl font-extrabold text-neutral-950 dark:text-white md:text-4xl">Menu</h1>
        <p class="text-neutral-950 dark:text-white">A collection of menu dropdown components built with Svelte and TailwindCSS.</p>
    </div>
