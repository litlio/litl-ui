<script lang="ts">
    ...
    let badges = [
        ...
        { id: 4, color: "blue" as const, variant: "filled" as const, content: "Rock", icon: { component: HandMetal, props: { size: 16 } }, rounded: true, state: "Rounded with Icon" },
...
<div class="container mx-auto p-4">
    <div class="my-16 text-center" id="title">
        <h1 class="mb-3 text-3xl font-extrabold text-neutral-950 dark:text-white md:text-4xl">Badge</h1>
        <p class="text-neutral-950 dark:text-white">A showcase of badge components built with Svelte and TailwindCSS.</p>
    </div>
