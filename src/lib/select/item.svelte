...
<button type="button"
	...
	class="relative w-full cursor-pointer bg-transparent transition-colors text-sm flex items-center rounded-sm py-1.5 px-2 hover:bg-neutral-100 hover:dark:bg-neutral-800"
>
