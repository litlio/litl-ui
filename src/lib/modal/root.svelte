<script lang="ts">
	...
	import { preventScroll } from '../utils/general.js';
...
<dialog bind:this={dialog} tabindex="-1">
	<div
	class="fixed top-0 left-0 w-full h-full flex items-center justify-center transition-colors
           bg-neutral-700/30 dark:bg-neutral-950/60 backdrop-blur-2xl"
>
	{@render children()}
</div>
